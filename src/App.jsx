  ...
  return (
      <main className={`app ${currentImg}`}>
        <h1 className='app__title animated-heading'>
          Fortune C<span className='animated-heading'><img className='donnutLetter' src={o} alt="" /></span>
                  <span className='animated-heading'><img className='donnutLetter' src={o} alt=""></img></span>kies</h1>
        <QuoteBox quote={quote}
                  handleRandomPhrase={handleRandomPhrase}/>
      </main>
  )
}
